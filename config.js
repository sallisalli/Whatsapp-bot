...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || '27_10_35b7_6ff8_fd38').trim(),
  DATABASE:
  ...
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '+94742943716,ꜱᴀɴᴅᴜɴ ᴍɪʜɪʀᴀɴɢᴀ',
  ...
  MENTION: process.env.MENTION || 'Hello',
  SS_TOKEN: process.env.SS_TOKEN || '123',
